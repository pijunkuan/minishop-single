...
class AdminOrderDetail extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            "refund_at" => $this['refund_status'] ? $this->refunds()->where('status', OrderRefund::REFUND_STATUS_REFUNDING)->orwhere('status',OrderRefund::REFUND_STATUS_REFUNDED)->first()->created_at->toDateTimeString() : null,
